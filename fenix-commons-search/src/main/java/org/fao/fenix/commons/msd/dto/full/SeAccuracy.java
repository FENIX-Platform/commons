...
public class SeAccuracy extends JSONEntity implements Serializable {
    ...
    @JsonProperty
    @Label(en="Accuracy - non sampling error",fr="Précision - erreur pas due au échantillonnage",es="Precisión - sin error de muestreo")
    ...
    @JsonProperty
    @Label(en="Accuracy - sampling error",fr="Précision - erreur d'échantillonnage",es="Precisión - error de muestreo")
